    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/updateUserInfoServlet" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="${userInfo.name}" id="name" name="name"
                   readonly="readonly" />
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="${userInfo.age}" id="age"  name="age"
                   placeholder="请输入年龄" />
          </div>
